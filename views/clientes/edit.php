<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="/clientes/update/<?php echo $cliente['ID_CLIENTE']; ?>" id="clienteForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo isset($_SESSION['errors']['NOME_CLIENTE']) ? 'is-invalid' : ''; ?>" 
                               ...
                               value="<?php echo htmlspecialchars($_SESSION['old']['NOME_CLIENTE'] ?? $cliente['NOME_CLIENTE']); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo isset($_SESSION['errors']['CPF']) ? 'is-invalid' : ''; ?>" 
                               ...
                               value="<?php echo htmlspecialchars($_SESSION['old']['CPF'] ?? $cliente['CPF']); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="email" class="form-control <?php echo isset($_SESSION['errors']['EMAIL']) ? 'is-invalid' : ''; ?>" 
                               id="EMAIL" name="EMAIL" 
                               value="<?php echo htmlspecialchars($_SESSION['old']['EMAIL'] ?? $cliente['EMAIL']); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="TELEFONE" name="TELEFONE" 
                               value="<?php echo htmlspecialchars($_SESSION['old']['TELEFONE'] ?? $cliente['TELEFONE']); ?>">
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control" id="CEP" name="CEP" 
                                   ...
                                   value="<?php echo htmlspecialchars($_SESSION['old']['CEP'] ?? $cliente['CEP'] ?? ''); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="ENDERECO" name="ENDERECO" rows="3"><?php echo htmlspecialchars($_SESSION['old']['ENDERECO'] ?? $cliente['ENDERECO']); ?></textarea>
                    </div>
