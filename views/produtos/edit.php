<div class="row justify-content-center">
    <div class="col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="/produtos/update/<?php echo $produto['ID_PRODUTO']; ?>" id="produtoForm" enctype="multipart/form-data">
                    <div class="mb-3">
                        <label for="IMAGEM" class="form-label">Imagem do Produto</label>
                        <?php if (!empty($produto['IMAGEM_URL'])): ?>
                            <div class="mb-2">
                                <img src="<?php echo htmlspecialchars($produto['IMAGEM_URL']); ?>" alt="Imagem atual" class="img-thumbnail" style="max-height: 200px;">
                        ...
                        <small class="text-muted">Deixe em branco para manter a imagem atual. Formatos aceitos: JPG, PNG, GIF (máx. 5MB)</small>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo isset($_SESSION['errors']['COD_BARRAS']) ? 'is-invalid' : ''; ?>" 
                               ...
                               value="<?php echo htmlspecialchars($_SESSION['old']['COD_BARRAS'] ?? $produto['COD_BARRAS']); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control <?php echo isset($_SESSION['errors']['NOME_PRODUTO']) ? 'is-invalid' : ''; ?>" 
                               ...
                               value="<?php echo htmlspecialchars($_SESSION['old']['NOME_PRODUTO'] ?? $produto['NOME_PRODUTO']); ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="DESCRICAO" name="DESCRICAO" rows="3"><?php echo htmlspecialchars($_SESSION['old']['DESCRICAO'] ?? $produto['DESCRICAO']); ?></textarea>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control <?php echo isset($_SESSION['errors']['VALOR_UNITARIO']) ? 'is-invalid' : ''; ?>" 
                               ...
                               value="<?php echo htmlspecialchars($_SESSION['old']['VALOR_UNITARIO'] ?? $produto['VALOR_UNITARIO']); ?>">
